...
PRICES_DATA = {
    "trial": {
        ...
        "price": "200 руб",
        "conditions": "*при покупке абонемента в день пробного занятия - бесплатно"
    },
    "kids": {
        "baby_sonya": {
            "name": "BABY by Sonya",
    ...
    "other": {
        ...
        "friends": {
            ...
            "price2": "75% - 3 друг",
            "price3": "100% - 4 друг",
            "conditions": "*приведи на тренировку друга и получи скидку на свой собственный абонемент"
        },
        "active": {
            "name": "Самый активный",
            "price": "5100",
            "conditions": "*для тех, кто занимается в 2х группах"
        },
        "family": {
            "name": "Для многодетных семей",
            "price": "10% - на 1 ребенкаа",
            "price1": "15% - на 2х детей",
            "price2": "20% - на 3х детей",
            "price3": "25% - на 4х детей",
        }
    }
}
